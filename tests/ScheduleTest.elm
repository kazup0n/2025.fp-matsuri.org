                ...
                \_ ->
                    let
                        ...
                        isDay1 commonProps =
                            let
                                parts =
                                    Time.Extra.posixToParts (TimeZone.asia__tokyo ()) commonProps.startsAt
                            in
                            parts.year == 2025 && parts.month == Jun && parts.day == 14
                    in
                    Expect.all
                        [ -- Track A Day 1
                          \_ -> gridPositionByUUID dummyItems "5699c262-e04d-4f58-a6f5-34c390f36d0d" |> Expect.equal "13 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "a8cd6d02-37c5-4009-90a4-9495c3189420" |> Expect.equal "43 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "76a0de1e-bf79-4c82-b50e-86caedaf1eb9" |> Expect.equal "55 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "034e486c-9a1c-48d7-910a-14aa82237eaa" |> Expect.equal "73 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "67557418-7561-47ec-8594-9d6c0926a6ab" |> Expect.equal "79 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "ea9fd8fc-4ae3-40c7-8ef5-1a8041e64606" |> Expect.equal "85 / span 6"

                        -- Track A Day 2
                        , \_ -> gridPositionByUUID dummyItems "61fb241f-cfaa-448a-892d-277e93577198" |> Expect.equal "13 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "ad0d29f8-46a2-463b-beeb-39257f9c5306" |> Expect.equal "25 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "3bdbadb9-7d77-4de0-aa37-5a7a38c577c3" |> Expect.equal "55 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "75644660-9bf1-473f-8d6d-01f2202bf2f2" |> Expect.equal "67 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "a6badfbb-ca70-474d-9abd-f285f24d9380" |> Expect.equal "73 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "e9df1f36-cf2f-4a85-aa36-4e07ae742a69" |> Expect.equal "85 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "02f89c3a-672e-4294-ae31-69e02e049005" |> Expect.equal "91 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "8bb407b5-5df3-48bb-a934-0ca6ca628c9a" |> Expect.equal "97 / span 6"

                        -- Track B Day 1
                        , \_ -> gridPositionByUUID dummyItems "b952a4f0-7db5-4d67-a911-a7a5d8a840ac" |> Expect.equal "13 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "b7a97e49-8624-4eae-848a-68f70205ad2a" |> Expect.equal "43 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "6109f011-c590-4c89-9add-89ad12cc9631" |> Expect.equal "55 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "f75e5cab-c677-44bb-a77a-2acf36083457" |> Expect.equal "73 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "6edaa6b5-b591-490c-855f-731a9d318192" |> Expect.equal "79 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "8acfb03f-19ea-476a-b6e6-0cb4b03fec1f" |> Expect.equal "85 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "73b09de0-c72e-4bbd-9089-af5c002f9506" |> Expect.equal "88 / span 2"

                        -- Track B Day 2
                        , \_ -> gridPositionByUUID dummyItems "d19de11e-d9a2-4b22-866e-2f95b8ac5c95" |> Expect.equal "13 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "b69688cf-06a2-4070-839c-4a6ec299c39c" |> Expect.equal "25 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "4ca1dabd-dbbe-47ca-a813-bc4c9700ccc9" |> Expect.equal "55 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "af94193a-4acb-4079-82a9-36bacfae3a20" |> Expect.equal "67 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "82478074-a43b-4d46-87a8-0742ed790e86" |> Expect.equal "73 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "2ceb7498-b203-44ee-b064-c0fbbe4a6948" |> Expect.equal "85 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "e7f30174-d4b9-40a7-9398-9f15c71009a9" |> Expect.equal "91 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "92b697d1-206c-426a-90c9-9ff3486cce6f" |> Expect.equal "97 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "e436393d-c322-477d-b8cb-0e6ac8ce8cc6" |> Expect.equal "100 / span 2"

                        -- Track C Day 1
                        , \_ -> gridPositionByUUID dummyItems "f3a8809b-d498-4ac2-bf42-5c32ce1595ea" |> Expect.equal "13 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "f7646b8b-29b0-4ac4-8ec3-46cabaa8ef1a" |> Expect.equal "43 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "56b9175d-1468-4ab0-8063-180491bb16ed" |> Expect.equal "55 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "3760ed3e-5b38-48b9-9db2-f101af1e580f" |> Expect.equal "73 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "350e2f70-0b02-4b79-b9f6-254a9d614706" |> Expect.equal "79 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "37899705-7d88-4ca4-bd5b-f674fc372d4e" |> Expect.equal "85 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "8dcaecb5-4541-4262-a047-3e330a7bcdb8" |> Expect.equal "88 / span 2"

                        -- Track C Day 2
                        , \_ -> gridPositionByUUID dummyItems "a916dd5a-7342-416a-980d-84f180a8e0a2" |> Expect.equal "13 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "7a342a71-90d4-43f9-9c4a-ce801fc9b49a" |> Expect.equal "25 / span 12"
                        , \_ -> gridPositionByUUID dummyItems "7cc6ecef-94c8-4add-abc0-23b500dbf498" |> Expect.equal "67 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "71fbd521-9dc5-458d-89f6-cbff8e84e3cc" |> Expect.equal "73 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "a82127a7-f84a-43c1-a3de-483e1d973a94" |> Expect.equal "85 / span 6"
                        , \_ -> gridPositionByUUID dummyItems "81cea14c-255c-46ff-929d-5141c5715832" |> Expect.equal "91 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "e0274da9-d863-47fe-a945-42eb04185bb9" |> Expect.equal "94 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "267ff4c1-8f3c-473b-8cab-e62d0d468af5" |> Expect.equal "97 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "983d1021-3636-4778-be58-149f1995e8a5" |> Expect.equal "99 / span 2"
                        , \_ -> gridPositionByUUID dummyItems "b6c70e2d-856b-47c5-9107-481883527634" |> Expect.equal "101 / span 2"

                        -- Must not happen
                        , \_ -> gridPositionByUUID dummyItems "unknown-uuid" |> Expect.equal "50"
                        ]
                        ()
            ]
        ]
